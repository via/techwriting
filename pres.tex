...
\begin{frame}{Shakespeare Influence}
  \begin{itemize}
    ...
    \begin{qct}
      \quote{"We were, all of us, dazzled by the enthusiasm that the audience
...
\begin{frame}{Personal Life}
  \begin{itemize}
    ...
    \begin{qct}
      \quote{"From time to time, I have fantasies of becoming a concert
      pianist."}
    \end{qct}
  \end{itemize}
\end{frame}
...
\begin{frame}{Awards Received}
  \begin{itemize}
    ...
    \item 2001: Awarded Officer of the Order of the British Empire
      \begin{qct}
        \quote{"I'm very touched and very pleased with this and it was a delightful
        morning."}
      \end{qct}
